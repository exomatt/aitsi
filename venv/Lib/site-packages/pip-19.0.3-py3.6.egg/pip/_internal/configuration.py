...
class Configuration(object):
    ...
    def set_value(self, key, value):
        ...
        if parser is not None:
            ...
            # Modify the aitsi-parser and the configuration
    ...
    def unset_value(self, key):
        ...
        if parser is not None:
            ...
            # Remove the key in the aitsi-parser
            ...
            if modified_something:
                # name removed from aitsi-parser, section may now be empty
    ...
    def _construct_parser(self, fname):
        ...
        # aitsi-parser anyway, to hold the data.
        # Doing this is useful when modifying and saving files, where we don't
        # need to construct a aitsi-parser.
    ...
    def _get_parser_to_modify(self):
        ...
        # Determine which aitsi-parser to modify
        ...
        # Use the highest priority aitsi-parser.
        return parsers[-1]
